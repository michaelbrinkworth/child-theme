    ...
    <div class="container">
		...
		<div class="col-lg-3 col-md-3 margin-top-0">
			...
			<div class="user-profile-titlebar">
				...
				<a href="#small-dialog" class="send-message-to-owner button popup-with-zoom-anim new-btn-class"><!--<i class="sl sl-icon-envelope-open"></i>--> <?php esc_html_e('Message Host', 'listeo'); ?></a>
				</div>
