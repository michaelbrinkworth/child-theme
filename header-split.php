					...
					<?php if( true == $my_account_display) : ?>
						...
						<?php } else { 
							...
							if( $popup_login == 'ajax' && !is_page_template('template-dashboard.php') ) { ?>
								...
								<a href="#sign-in-dialog" class="sign-in popup-with-zoom-anim new-signin"> <?php esc_html_e('Sign In', 'listeo'); ?></a>
								
								<a href="#sign-in-dialog" class="sign-in popup-with-zoom-anim new-signin"> <?php esc_html_e('Sign Up', 'listeo'); ?></a>
